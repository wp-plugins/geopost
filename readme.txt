...
1. Place the shortcode `[geopost]` in any post or page
...
1. Map of markers for posts that is inserted in place of the shortcode [geopost] in any page or post.
2. In the admin page for your posts you can search for a location to assign to that post.
